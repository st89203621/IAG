...
(
	...
	and strsrc_ip in ('154.121.39.250', '154.121.39.222' , '154.121.39.235')
...
where EXISTS (
	...
	WHERE capture_day in ('2025-05-05')
	and ACTION in ('Start', 'Stop')
	and internet_ip in ('154.121.39.250', '154.121.39.222' , '154.121.39.235')
